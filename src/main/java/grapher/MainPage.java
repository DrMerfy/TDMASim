...
public class MainPage {
    ...
    @FXML
    public StackPane loading_dialog;
    @FXML
    public StackPane node_holder;
    @FXML
    public ScrollPane r_holder;
    @FXML
    public JFXTextField num_nodes;
    @FXML
    public JFXTextField list_size;
    @FXML
    public JFXTextField num_circles;
    @FXML
    public JFXButton btn_start;
    @FXML
    public JFXToggleButton btn_bursty;
    @FXML
    public Label r_values;
